...
class AssignCategoryTab extends Generic implements TabInterface
{
    ...
    public function initForm()
    {
        ...
        $fieldset = $form->addFieldset('base_fieldset', ['legend' => __('Assign Category')]);

        $collection = $this->_objectManager->create('Webkul\Marketplace\Block\Adminhtml\Customer\Edit')
        ...
        if (count($collection)) {
            ...
            $rowcom = $this->_objectManager->create('Webkul\Marketplace\Block\Adminhtml\Customer\Edit')
