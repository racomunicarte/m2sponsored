...
namespace Magneto\Sponsored\Controller\Product;

use Magento\Customer\Model\Session;
use Magento\Framework\App\Action\Context;
use Magento\Framework\Data\Form\FormKey\Validator as FormKeyValidator;
use Webkul\Marketplace\Controller\Product\SaveProduct as SaveProduct;
            ...
            try {
                ...
                if ($productId != '') {
                    if (empty($errors)) {
                        ...
                        //If product is sponsored, redirect to checkout
                        if (!empty($wholedata['product']['is_sponsored'])
                            && isset($wholedata['product']['is_sponsored'])
                        ) {
